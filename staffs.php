...
<body>
    ...
    <div id="contener_staff">
        ...
        <table>
            ...
            <tr>
                     <td>3</td>
                     <td>SHUBHENDU KUMAR CHOUDHARI</td>
                        <td>Guest Faculty of MCA</td>
                        <td>+917979968193</td>
                     <td><img src="image/stf-img.png" height="40px" width="50px"></td>
                    </tr>
             <tr>
                     <td>4</td>
                     <td>Md. Tarique Anwar</td>
                        <td>R.C. Record Room</td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -</td>
                     <td><img src="image/stf-img.png" height="40px" width="50px"></td>
                    </tr>
             ...
             <tr>
                     <td>5</td>
                     <td>Shri Shailandra Kumar</td>
                        <td>Section Officer & P.A. to VC
							General Section</td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -</td>
                     <td><img src="image/stf-img.png" height="40px" width="50px"></td>
                    </tr>
