...
<body>
    ...
    <div id="college_image">
        <img src="image/img2448/college.jpg" alt="COLLEGE IMAGE" height="400px" width="100%">
    </div>
    <div id="clear"></div>
    <!--nav or menu bar -->
    <div id="nav">
    ...
    <div id="contener">
        <div class="contener_slaid">
          <div class="pics">
        <img src="image/slides/f-bener/1.jpg" width="800" height="300"/> 
        <img src="image/slides/f-bener/2.jpg" width="800" height="300"/>  
        <img src="image/slides/f-bener/6.jpg" width="800" height="300"/>
        <img src="image/slides/f-bener/4.JPG" width="800" height="300"/> 
        <img src="image/slides/f-bener/5.jpg" width="800" height="300"/>  
        <img src="image/slides/f-bener/3.jpg" width="800" height="300"/>
		<img src="image/slides/f-bener/7.jpg" width="800" height="300"/>
...
<p>Established in 11 April 2017, this University has been pioneer in the field of education with excellent track of imparting quality education. Here you find learned faculty members with rich experience in Academia who takes personal interest in each student of ours.</p>
...
<p><i>The college has played a significance role in motivating and educating underprivileged group of students coming from tribal, dalit and backward populace of the state. The result of the college has always been commendable.</i></p>
   ...
   <div id="right_section">
      <div class="login">
       ...
       <div class="notice">
          ...
          <ol type="1">
        <li><a href="notices.php">Admission Will be Start on 12/12/2019 to Close Date 10/6/2020.</a>  <img src="image/new.gif"/></li>
            <li><a href="notices.php">08/12/2019 UG/PG/B.A./B.Com. Part I (Hons./Gen.) Exam Result 2019 </a>  <img src="image/new.gif"/></li>
            <li><a href="notices.php">Programme for B.A/B.Sc/B.Com Part -II ( Hons/Gen/Sub) Exam 2019.</a>  <img src="image/new.gif"/></li>
              <li><a href="notices.php">Result of Bachelor of Arts/science/Commerce Hons. /Gen/ PART-I Examinations 2016 held in the month of June 2020.</a>  <img src="image/new.gif"/></li>
              <li><a href="notices.php">Result of Bachelor of Arts/Science/Commerce Vocational Hons. PART-III Examinations 2017 held in the month of April 2020.</a>  <img src="image/new.gif"/></li>
              <li><a href="notices.php">Result of Bachelor of science Hons. /Gen/ PART-I Examinations 2020 held in the month of June 2019.</a>  <img src="image/new.gif"/></li>
              <li><a href="notices.php">Programme for B.A/B.Sc/B.Com Part -II ( Hons/Gen/Sub) Exam 2020.</a></li>
              <li><a href="notices.php">Intermediate Last date of Admission is 10th January 2020.</a></li>
              </ol>
             </marquee>
   ...
   <div id="section">
     <div class="section_A">
        <img src="image/vc.jpg"/>
        <h1>PROFESSOR INCHARGE</h1> 
        <h2>DR. S N MUNDA</h2> 
      </div>
      <div class="section_A">
         <img src="image/namita.jpg"/>
         <h1>D S W</h1> 
        <h2>DR. (Mrs.) NAMITA SINGH</h2>  
      </div>
      <div class="section_A">
