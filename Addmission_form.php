...
<div class="container1">
  ...
  <tr style="background-color:#CFF">
    ...
    <option>I.A</option><option>I.Sc</option><option>I.Com</option><option>B.A</option><option>B.Sc</option><option>B.Com</option><option>BCA</option><option>MA</option><option>M.Com</option><option>M.Sc</option><option>MCA</option></select>
    </td>
    <td>Semester</td>
    <td>
    <select name="semester" id="semester" style="width:100px;">
    <option value="">Select</option><option value='PART I'>PART I</option><option value='PART II'>PART II</option><option value='PART III'>PART III</option> <option>SEM-I</option> <option>SEM-II</option> <option>SEM-III</option>  <option>SEM-IV</option> <option>SEM-V</option> <option>SEM-VI</option>  </select>
    </td>
  </tr>
      </table>
