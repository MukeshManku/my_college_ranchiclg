...
<body>
    ...
    <div id="contener_staff_v">
        ...
        <div id="voc_sec1">
         <h2>Composition (for Sem-I and Sem-VI)</h2>
        <ol>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td text-align="center"><strong>Sem-I & II</strong></td>
                ...
                <tr>
                    <td><strong>Sem-III & IV</strong></td>
                    <td colspan="5"><strong>Theory Papers</strong></td>
                </tr>
                <tr>
                    <td>5a</td>
        ...
        <p class="text-justify">
            ...
            non-vocational subjects as subsidiary papers for SEM-I and SEM-VI examinations
